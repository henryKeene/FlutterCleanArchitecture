...
sealed class ThemeTokens {
  ...
  // Test Colors, replace with above brand colors in the color scheme.
  static const Color lightBlue = Color(0xFF99D5C9);
  static const Color darkBlue = Color(0xFF6C969D);
  static const Color indigo = Color(0xFF645E9D);
  static const Color darkPurple = Color(0xFF3C1053);
  ...
  static const double appRadius = 10;
