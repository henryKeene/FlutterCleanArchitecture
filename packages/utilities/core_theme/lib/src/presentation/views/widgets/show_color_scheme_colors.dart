...
class ColorChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final labelColor = onColor ?? _contrastColor(color);
    final effectiveSize = size ?? _onChipSize;
...
class ColorGroup extends StatelessWidget {
  ...
  const ColorGroup({required this.children, super.key});
...
class ShowColorSchemeColors extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final tones = FlexTones.candyPop(theme.brightness);
